...
export function RegistrationFormFixed() {
  ...
  const handleSubmit = async (formData: FormData) => {
    ...
    try {
      ...
      // Handle file upload without trying to create bucket
      if (licenseFile) {
        ...
        try {
          ...
          if (uploadError) {
            ...
            setMessage({
              type: "warning",
              text: `Document upload failed: ${uploadError.message}. Registration will continue without the document.`,
            })
          } else {
            const {
              data: { publicUrl },
          ...
          setMessage({
            type: "warning",
            text: `Document upload failed. Registration will continue without the document.`,
          })
        }
      }
      ...
      setMessage({
        type: "error",
        text: `Registration failed: ${error.message}. Please try again or contact support.`,
      })
      setUploadStatus("error")
    }
