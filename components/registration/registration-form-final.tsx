...
export function RegistrationFormFinal() {
  ...
  const handleSubmit = async (formData: FormData) => {
    ...
    try {
      ...
      if (licenseFile) {
        ...
        try {
          ...
          if (uploadError) {
            ...
            // Continue without file - don't fail registration
          } else {
            const {
              data: { publicUrl },
      ...
      setMessage({
        type: "success",
        text: "Registration completed successfully! Your account is pending approval and bank accounts have been created.",
      })
